...
#define TS(n) Rule::Chain::T(n)
  ...
  Greibach greibach(
    ...
    Rule(NS('G'), GRB_ERROR_SERIES + 6,
      ...
      Rule::Chain(4, TS('-'), TS('i'), TS('g'), TS('i')),
      Rule::Chain(4, TS('-'), TS('l'), TS('g'), TS('i')),
      Rule::Chain(4, TS('-'), TS('i'), TS('g'), TS('l')),
      Rule::Chain(4, TS('-'), TS('l'), TS('g'), TS('l')),
      Rule::Chain(4, TS('i'), TS('g'), TS('-'), TS('i')),
      Rule::Chain(4, TS('l'), TS('g'), TS('-'), TS('i')),
      Rule::Chain(4, TS('i'), TS('g'), TS('-'), TS('l')),
      Rule::Chain(4, TS('l'), TS('g'), TS('-'), TS('l')),
      Rule::Chain(5, TS('-'), TS('i'), TS('g'), TS('-'), TS('i')),
      Rule::Chain(5, TS('-'), TS('l'), TS('g'), TS('-'), TS('i')),
      Rule::Chain(5, TS('-'), TS('i'), TS('g'), TS('-'), TS('l')),
      Rule::Chain(5, TS('-'), TS('l'), TS('g'), TS('-'), TS('l'))
    ),
